    ...
    <div className="relative z-10">
      ...
      <section className="py-24 bg-black/90 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 px-10 md:px-20">
          {[
            { title: "Vehicle Logistics", desc: "Enclosed transport, storage coordination, detailing management, and support for high-value or exotic automobiles, etc..." },
...
export default function SpannConciergeSite() {
  ...
  const renewalTiers = [
    { id: 1, tier: 'Tier I', price: '$400 / Month', desc: 'You get a reliable go-to operator who handles the everyday tasks you don’t want to deal with — travel planning, logistics, coordination, reminders, and small but time-consuming errands.', includes: ['Restaurant Reservations','Basic Travel Bookings (Flights & Hotels)','Event Planning Coordination (Small Events)','Errand Coordination','Personal Shopping Requests','Grocery Delivery Coordination','Pet Sitting / Dog Walking Coordination','Home Cleaners Coordination','Plumbers Coordination','Electricians Coordination','HVAC Coordination','Pest Control Coordination','Yard & Landscaping Coordination','Pool Services Coordination','General Handyman Coordination','Tutors/Education Coordination','Mobile Notary Coordination','Massage Coordination','Stylists Coordination','Tailor Coordination','Vet Coordination']},
    { id: 2, tier: 'Tier II', price: '$550 / Month', desc: 'This tier becomes your personal operations manager. We handle recurring needs, keep your assets running smoothly, coordinate multiple moving parts, and solve problems faster.', includes: ['Everything in Tier 1','Car Detailing Coordination','Transport/Towing Coordination','Auto Storage Coordination','Auto Tuning/Performance Shops Coordination', 'Auto Dealers Coordination','Mobile Mechanics Coordination','Tint/PPF/Coating Shop Coordination','Auto Upholstery Coordination','Bodyguards Coordination','Chauffeur Services','Photographers Coordination','Private Chefs Coordination','Bartending Services Coordination','Florists Coordination','Caterers Coordination','Event Rental/Decor Coordination','Security System Installers Coordination','Cybersecurity Coordination','Interior Designers Coordination','General Contractors Coordination','Home Renovation Oversight','Pet Groomers Coordination','Pet Boarding Coordination','Hard-to-Book Venues Coordination']},
    { id: 3, tier: 'Tier III', price: '$950 / Month', desc: 'You get elite, immediate support for every aspect of your lifestyle: travel, vehicles, events, logistics, emergencies, and complex coordination.This is the tier for clients who need speed, privacy, reliability, and concierge-level execution around the clock — without compromise.', includes: ['Everything in Tier 2','Jets & Private Aviation Coordination','Yacht/Boat Charter Coordination','Luxury Travel Planners','Chauffeur Premium','VIP Tables & Nightlife Access','Exclusive Events Access','Membership Clubs Access Requests','Ticket Services (Sold Out/High Demand)','White-Glove Shipping Coordination','Item Couriers','Watch Dealer Sourcing','Jewelry Specialist Sourcing','Art Dealer Sourcing','Auction House Liaisons','Personal Assistant Coordination','High-End Vehicle Sourcing','Private Doctor Coordination','Medical Specialists Coordination','Financial Advisors Coordination','Retirement Planners Coordination','Tax Planners Coordination','Hedge Fund Introductions']},
]
